...
| **BREAKING_DISTANCE_TURN1**        | Distance where car begins to brake before entering Turn 1                                                        | 1) Take `LAP_DISTANCE` where `BRAKE` is greater than a threshold. 2) Record first instance of breach.                                                                       |
